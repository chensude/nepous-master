...
package com.nepous.core.generator;
...
public class IncrementIdGenerator implements IdGenerator {
	...
	public Long nextId() {
		...
		if (regCenter.isExisted(path)) {
			System.out.println("id:=="+Long.valueOf(regCenter.getDirectly(GlobalConstant.ZK_REGISTRY_ID_ROOT_PATH + GlobalConstant.Symbol.SLASH + app + GlobalConstant.Symbol.SLASH + host)));
