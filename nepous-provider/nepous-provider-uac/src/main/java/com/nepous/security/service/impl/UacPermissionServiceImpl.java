package com.nepous.security.service.impl;

import com.google.common.base.Joiner;
import com.nepous.base.constant.GlobalConstant;
import com.nepous.security.security.SecurityUtils;
import com.nepous.security.service.UacPermissionService;
...
public class UacPermissionServiceImpl implements UacPermissionService {
	...
	public boolean hasPermission(Authentication authentication, HttpServletRequest request) {
		...
		log.info("验证权限22loginName={}, requestURI={}, hasAuthorityUrl={}", currentLoginName, requestURI, Joiner.on(GlobalConstant.Symbol.COMMA).join(currentAuthorityUrl));
		// 超级管理员 全部都可以访问
		if (StringUtils.equals(currentLoginName, GlobalConstant.Sys.SUPER_MANAGER_LOGIN_NAME)) {
			return true;
		}

		// 项目Feign客户端具有所有权限, 如果需要则在角色权限中控制
